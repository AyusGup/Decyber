...
export default function Login(props) {
    ...
    const submitHandler = async (e) => {
        ...
        setLoader(true);
        const response = await fetch("https://decyber-m8yv.onrender.com/api/auth/login", {
            method: "POST",
            headers: {
        ...
        <div className='Login'>
            <div className='container login_form' style={{ width: "45%" }}>
                {!loader ? <form onSubmit={submitHandler}>
                    ...
                    <button type="submit" className="btn btn-primary" style={{ backgroundColor: "#212529", color: "#e0b31d", border: "none" }}>Login</button>
